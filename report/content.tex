...
\begin{table}[htbp]
	...
	\begin{tabularx}{\textwidth}{p{2cm}p{2cm}p{2cm}p{2cm}p{4cm}p{4cm}}
		\textbf{Reference} & \textbf{Description} & \textbf{Architecture} & \textbf{System} & \textbf{Findings} & \textbf{Limitations}  \\ 
		\hline
